  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageHeader}>
        <Image 
          source={{ uri: imageUrl as string || 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800' }} 
...
const styles = StyleSheet.create({
  ...
  backBtn: { position: 'absolute', top: 50, left: 20, backgroundColor: '#FFF', padding: 10, borderRadius: 20, elevation: 5, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 5 },
  content: { marginTop: -30, backgroundColor: '#FFF', borderTopLeftRadius: 30, borderTopRightRadius: 30, paddingHorizontal: 20 },
  infoSection: { paddingTop: 25 },
  title: { fontSize: 28, fontWeight: '800', color: '#1A1A1A' },
  metaRow: { flexDirection: 'row', alignItems: 'center', marginTop: 12, gap: 15 },
  ratingBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF9E6', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10 },
  ...
  cartBtn: { backgroundColor: '#FF6B35', flexDirection: 'row', alignItems: 'center', padding: 18, borderRadius: 20, justifyContent: 'space-between', elevation: 10, shadowColor: '#FF6B35', shadowOpacity: 0.4, shadowRadius: 10 },
